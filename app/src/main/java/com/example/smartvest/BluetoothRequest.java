...
public class BluetoothRequest extends StringRequest {
    ...
    public BluetoothRequest(String userID, String str_datetime, String str_btn,String str_dust,String str_co,String str_hum,String str_temp,Response.Listener<String> listener){
